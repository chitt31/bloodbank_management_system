...
$conn=mysqli_connect("localhost","root","1234","blood_donation") or die("Connection error");
        ...
        <form name="sentMessage"  method="post">
            <div class="control-group form-group">
                <div class="controls">
                    ...
                    <input type="text" class="form-control" id="name" name="fullname" required  placeholder="name">
            ...
            <div class="control-group form-group">
                <div class="controls">
                    <label>Message:</label>
                    <textarea rows="10" cols="100" class="form-control" id="message" name="message" required  maxlength="999" style="resize:none" placeholder="enter your message"></textarea>
                </div>
            </div>
