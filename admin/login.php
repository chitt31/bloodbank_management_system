...
<body background="admin_image\blood_a.jpg " style= "background-repeat:no-repeat;background-position: center center;">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6"style="text-align: center;">
              <h1 class="mt-4 mb-3" style="color:#3D0C11 ;">
                  <b>Blood Bank & Management Admin Login Portal</b>
                </h1>

            </div>
      </div>
      <div class="card" style="height:250px; background-color:#F8F0E5;">
          <div class="card-body">
